...
\subsection{3.5}
We didn't quite figure out how to solve this exercise. Our best guess is that we need to look at the dual graph (i.e. where the faces are vertices) and letting $z_{fg}$ be the flow between vertices, but we couldn't figure out what the edge capacities should be (infinite?) or what the b values should be.
